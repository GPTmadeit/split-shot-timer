...
This project concerns firearms practice equipment. Discussion should stay on the technical
subject matter: acoustics, timing, detection accuracy, and the software itself.

Content advocating violence, unlawful use of firearms, or circumvention of firearms law is out
of scope and will be removed. Political argument about firearms policy is likewise off-topic
here — there are better places for it, and it makes this a worse place to collaborate on a
timer.
...
community leaders responsible for enforcement by opening a
[private security advisory](https://github.com/GPTmadeit/split-shot-timer/security/advisories/new),
which is the private reporting channel available on this repository.
